...
// namespace da interface, mais nome da interface
@WebService(endpointInterface = "com.jotasantos.TesteSuficiencia.servico.ICertidaoNascimento")
public class CertidaoNacimentoImpl implements ICertidaoNascimento {
